...
class QTITAN_EXPORT GridEditorStyleOption: 
...
public:
    ...
    virtual const QVariant& getContextValue() const = 0;
...
public:
    ...
    virtual const QVariant& getContextValue() const;
...
public:
    ...
    virtual QString valueToText(const QVariant& value);
...
class QTITAN_EXPORT GridProgressEditorRepository: public GridNumericEditorRepository
{
public:
...
public:
    ...
    virtual int widthForHeight(int height, const QVariant& v);
    virtual int heightForWidth(int width, const QVariant& v);
...
public:
    ...
    int popupButtons() const;
    void setPopupButtons(int buttons);
protected:
    virtual QWidget* editorWidget() = 0;
    virtual void undoModified() = 0;
    virtual void createPopup() = 0;
...
private:
    ...
    int m_oldRowIndex;
private Q_SLOTS:
    void grid_focusRowChanged(int oldRowIndex, int rowIndex);
    void grid_rowClicked(RowClickEventArgs* args);
};
...
public:
    ...
    virtual void setValueToWidget(const QVariant& value);
private:
    void resolveValue(int modelRowIndex, QVariant& value);
