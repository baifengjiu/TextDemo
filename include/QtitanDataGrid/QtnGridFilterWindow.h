...
class FindDialogGridEditorSite;
...
private:
    ...
    QWidget* m_editorContainer1;
    QWidget* m_editorContainer2;
    FindDialogGridEditorSite* m_editor1;
    FindDialogGridEditorSite* m_editor2;
...
class FilterHistoryPopupPrimitive : public QObject, public GridWinShadowedPrimitive
{
    Q_OBJECT
public:
    FilterHistoryPopupPrimitive(GridViewPrimitiveBase* parent, GridFilterHistory* history);
